...
# 1. Si no está logueado, mandar al Login del Admin (porque aún no tienes login propio)
LOGIN_URL = '/admin/login/' 

# 2. Al entrar exitosamente, mandar al panel de Zoom
LOGIN_REDIRECT_URL = '/zoom/' 

# 3. Al salir, mandar al inicio
